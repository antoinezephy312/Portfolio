...
export function MailIcon(props) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="m3 7 8.35 5.57a1.2 1.2 0 0 0 1.3 0L21 7" />
    </svg>
  );
}
